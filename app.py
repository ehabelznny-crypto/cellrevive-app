...
UI_TEXT = {
    'العربية': {
        ...
        'disclaimer_body': "<b>تنبيه فسيولوجي وقانوني صارم:</b> إن منصة CellRevive AI هي منظومة هندسة رقمية متقدمة وأداة تثقيفية محاكية لإصلاح الخلايا وإعادة التوازن الميتوكوندري، وتعمل تحت الإشراف العلمي المباشر للمؤسس د/ إيهاب حشمت الظني. التقارير والمنحنيات الصادرة هي موجهات استرشادية فائقة الدقة ولا تعتبر بديلاً عن الفحوصات المختبرية السريرية المباشرة. لا يحق للمشترك تعديل أو إيقاف أي جرعات دوائية كيميائية موصوفة له إلا بمراجعة الطبيب المعالج والمتابع للحالة. تخلي إدارة المنصة مسؤوليتها الكاملة عن أي قراءة أحادية للبيانات خارج نطاق الإرشاد المشرف.",
