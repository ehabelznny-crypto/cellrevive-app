...
if st.button("🚀 تفعيل محرك الترميم الخلوي وإصدار التقرير المتكامل المعقد", use_container_width=True):
    ...
    # زيادة الحساسية والدقة بمقدار 100 مرة بربط المؤشرات الحجمية بالمعادلات السيادية المتقدمة
    ...
    # معالجة القائمة الموسعة للأدوية الـ 15 المتزامنة وفق توجيهات وزارة الصحة المصرية 2026
    ...
    with col_d2:
        ...
        st.write("* احظر تماماً الططهي بالسمن النباتي أو الزيوت المهدرجة لحماية جدران الخلايا وغشائها الدهني المصاب بالالتهابات الأيضية.")
