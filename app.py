...
st.markdown('<div class="sub-title">المنصة العالمية الموحدة للترميم الخلوي وإصلاح الحياة - بإشراف د. إيهاب لعام 2026</div>', unsafe_allow_html=True)
...
# تهيئة وإدارة جلسات الولوج والتفعيل المتوافقة مع الموبايل
