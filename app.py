...
# العنوان الرئيسي للمنصة المتكاملة الأولى للترميم الخلوي
st.markdown('<div class="main-title">🧬 CELLREVIVE AI • المنظومة المتكاملة</div>', unsafe_allow_html=True)
st.markdown('<div class="sub-title">المنصة العالمية الموحدة للترميم الخلوي وعكس مسار مقاومة الانسولين والسكري من النوع الثاني- بإشراف د. إيهاب حشمت الظني </div>', unsafe_allow_html=True)
...
if st.button("🚀 تفعيل محرك الترميم الخلوي وإصدار التقرير الإمبراطوري المعقد", use_container_width=True):
    ...
    =======================================================
    منصة الترميم الخلوي الأولى عالمياً لعام 2026 - بإشراف د. إيهاب
    ...
    st.text_area("معاينة مستند التقرير الطبي السيادي الموجه قبل التحميل والطباعة:", report_text, height=250)
